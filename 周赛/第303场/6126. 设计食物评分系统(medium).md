...
```
- 初始化系统。食物由  foods cuisines和 ratings描述，长度均为 n 。
...
hash记录烹饪方式-><评分，食物>，set是平衡数，默认从小到大排序，因此评分加个负号

r记录食物->评分

c记录食物->烹饪方式

FoodRatings:将信息记录到三个哈希表中

changeRating:通过食物找到烹饪方式，然后更新hash和r表

highestRated:返回指定烹饪方式的最高分的食物名字
